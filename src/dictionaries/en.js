const en = {
  ...
  footer: {
    rights: "— Issa AbuHadhoud. Built with Next.js.",
  },
  home: {
    ...
    certsLabel: "Continuous Learning",
  ...
  about: {
    ...
    categories: { frontend: "Frontend", backend: "Backend", databases: "Databases", tools: "Tools" },
  },
  project: {
    label: "My Work",
    title: "Projects",
  ...
  training: {
    ...
    body: "Hands-on programs and real work experience that sharpened my full-stack skill set beyond the classroom. Certificates are available to view or download below.",
  ...
  resume: {
    ...
    body: "Get a full overview of my experience, education, and technical skills as a PDF you can keep, print, or share.",
  ...
  contact: {
    ...
    infoBody: "Prefer a quicker reply? Reach out directly through any of these.",
    emailLabel: "Email",
    phoneLabel: "Phone",
    ...
    errors: {
      ...
      server: "Something went wrong sending your message. Please try again, or email me directly at ",
    },
  },
  meta: {
    home: {
    ...
    contact: {
      title: "Contact",
      description:
        "Get in touch with Issa AbuHadhoud, Full-Stack Developer, for freelance work or full-time opportunities.",
    },
  },
};
